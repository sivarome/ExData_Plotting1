...
#================= Plotting Data =================
#Plot the data: Energy sub-metering during the given period
#Open the png device to save the image as a png file
png("plot3.png",width=480,height=480,units="px", bg="transparent")

#Set the plot area with axis labels
...
#Plot the lines for each of the three sub metering readings
